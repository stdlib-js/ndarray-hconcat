...
```javascript
import hconcat from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-hconcat@esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-hconcat@esm/index.mjs';
```
